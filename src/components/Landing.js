    ...
    return (
        <div className="mx-auto my-40">
            ...
            <div className="flex gap-96 align-middle justify-center items-center">
                ...
                <button type="button" class="font-bold text-xl ml-20 px-5 py-3 text-white bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 rounded-lg text-center me-2 mb-2">
                    Yess!
                </button>
            </div>
